...
if __name__=="__main__":  
    ...
    print("Sort t-shirts by Fabric in ascending position with Quick Sort:")
    #call quick_sort() function with its three Arguments
    quick_sort(0, len(fabric) - 1, fabric)
    ...
    print("-" *100)
    print("-" *100)
    print("Sort t-shirts by Fabric in descending position with Quick Sort: ")

...
if __name__=="__main__":  
    ...
    print("-" *100)
    print("-" *100)
    print("Sort t-shirts by Fabric in ascending position with Bubble Sort:")
    bubbleSort_asce(fabric)
    print("-" *100)
    print("-" *100)
    ...
    print("-" *100)
    print("-" *100)
    print("Sort t-shirts by Fabric in descending position with Bubble Sort: ")

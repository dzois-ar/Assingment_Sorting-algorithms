...
if __name__=="__main__":  
    ...
    print("-" *100)
    print("-" *100)
    print("Sort t-shirts by Size in ascending position with Bucket Sort:")
    bucketsort_asce(size)
    ...
    print("-" *100)
    print("-" *100)
    print("Sort t-shirts by Size in descending position with Bucket Sort: ")
